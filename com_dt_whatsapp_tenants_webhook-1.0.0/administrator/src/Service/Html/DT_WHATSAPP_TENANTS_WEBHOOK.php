...
namespace Comdtwhatsapptenantswebhook\Component\Dt_whatsapp_tenants_webhook\Administrator\Service\Html;
...
/**
 * Dt_whatsapp_tenants_webhook HTML Helper.
 *
 * @since  1.0.0
 */
class DT_WHATSAPP_TENANTS_WEBHOOK
{
