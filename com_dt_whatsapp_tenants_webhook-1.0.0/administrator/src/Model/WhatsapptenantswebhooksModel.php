...
/**
 * Methods supporting a list of Whatsapptenantswebhooks records.
 *
 * @since  1.0.0
 */
class WhatsapptenantswebhooksModel extends ListModel
{
	/**
	* Constructor.
	*
	...
	*/
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__dt_whatsapp_tenants_webhook` AS a');
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.field LIKE ' . $search . '  OR  a.value LIKE ' . $search . '  OR  a.detail LIKE ' . $search . ' )');
			}
		}
